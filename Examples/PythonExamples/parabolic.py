...
if not open your command prompt cmd then Enter: pip install vpython '''
'''Gyroscope sitting on a pedestal, The analysis is in terms of Lagrangian mechanics.
The Lagrangian variables are polar angle theta,azimuthal angle phi, and spin angle psi.'''
